...
#define PAK0_COUNT		339	/* valve/pak0.pak - v1.0x */
#define PAK0_CRC_V100		13900	/* valve/pak0.pak - v1.00 */
#define PAK0_CRC_V101		62751	/* valve/pak0.pak - v1.01 */
#define PAK0_CRC_V106		32981	/* valve/pak0.pak - v1.06 */
#define PAK0_CRC	(PAK0_CRC_V106)
#define PAK0_COUNT_V091		308	/* valve/pak0.pak - v0.91/0.92, not supported */
#define PAK0_CRC_V091		28804	/* valve/pak0.pak - v0.91/0.92, not supported */
...
// reconstitute the command line for the cmdline externally visible cvar
    ...
    // commented out due to new silversrc one Con_Printf("SilverSrc Version 0.0.1 VERY VERY EARLY ALPHA!!!!!!\n");
...
static void COM_Game_f (void)
{
	if (Cmd_Argc() > 1)
	{
		...
		{
			if (com_searchpaths->path_id > 1) { //current game not valve
		...
		if (q_strcasecmp(p, GAMENAME)) //game is not valve
		{
			if (*p2) {
		...
		Con_Printf("enter \"exec valve.rc\" to load new configs\n");
